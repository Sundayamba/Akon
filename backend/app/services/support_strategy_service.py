...
EMOTION_STRATEGIES: dict[str, dict[str, str]] = {
    "overwhelmed": {
        ...
        "reflection": "This looks like stress or overwhelm, not failure.",
    ...
    "stressed": {
        ...
        "reflection": "This looks like pressure asking for order.",
        "step": "One small step for now: name the next task that would lower the pressure even slightly.",
    },
    "sad": {
        "validation": "That sounds painful, and you do not have to rush past it.",
        "reflection": "Sadness may be close to the surface here.",
        "step": "One small step for now: tell me what part of this hurts the most.",
    },
    "anxious": {
        "validation": "That sounds unsettling, and it makes sense that your mind is scanning for what could go wrong.",
        "reflection": "This looks like worry asking for clarity.",
    ...
    "angry": {
        ...
        "reflection": "Anger may be pointing at something that feels unfair or blocked.",
    ...
    "lonely": {
        ...
        "reflection": "Loneliness may be part of this moment.",
    ...
    "confused": {
        ...
        "reflection": "This looks like confusion, not failure.",
    ...
    "hopeful": {
        ...
        "reflection": "There is some cautious optimism here.",
    ...
    "calm": {
        ...
        "reflection": "This looks like a calmer place to make the next choice from.",
    ...
    "neutral": {
        ...
        "reflection": "I do not need to force a feeling label onto it.",
...
def build_support_reply(
    ...
    if memory_context:
        closing = "I am taking your saved context into account where it is useful. " + closing
